...
public class AUTO_Red2 extends SequentialCommandGroup {
  ...
  public AUTO_Red2(SwerveDrivetrain drivetrain, AUTO_Trajectory trajectory, SUB_Intake p_Intake, SUB_Shooter p_shooter, FSM_IntakeStatus p_intakeStatus) {
